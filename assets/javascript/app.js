$(document).ready(function () {
    ...
    function submitAnswers() {
        ...
        // correct answers adoy!
        var correctAnswer = ["c", "c", "a", "b", "d"];
    ...
    // you're using the decrement function to count down seconds
    function decrement() {
        seconds--;
    ...
    // function for wrong/correct answers put this function in stop function to display them when the time is up (if statements)
    function displayResults() {
        $("#results").text("You answered correctly " + correct + " questions out of 5.");
    }

    //results are showing up on start button
    function reset() {
        var correct = 0;
        $("#questions-display").hide();
        $("#submit-button").hide();
